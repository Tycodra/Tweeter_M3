...
public class FolloweesRequest {
     ...
     *                     previous request).
     */
    public FolloweesRequest(AuthToken authToken, String followerAlias, int limit, String lastFolloweeAlias) {
